...
> **Contexte projet (AfrivoiceAI)** — Ce dépôt est une application **web Next.js 14
> (App Router) + Tailwind CSS + shadcn/ui**, PAS React Native. Les exemples plus
> bas utilisent parfois `--stack react-native` : pour ce projet, utilisez plutôt
> `--stack nextjs`, `--stack react` ou `--stack shadcn`, et le domaine `react`
> pour la performance. Le script s'invoque depuis la racine du repo :
