...
CREATE TABLE IF NOT EXISTS "organizations" (
	...
	CONSTRAINT "organizations_shopify_domain_unique" UNIQUE("shopify_domain"),
	CONSTRAINT "organizations_woo_domain_unique" UNIQUE("woo_domain")
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "orders_external_unique_idx" ON "orders" USING btree ("organization_id","source","external_id");--> statement-breakpoint
